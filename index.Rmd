...
pkgs <- c(
  "knitr", "rmarkdown",
  "tibble", "dplyr", "readr", "stringr", "lubridate", "jsonlite"
)
...
```{=html}
<section>
  <h2>📹 Cámaras en vivo – México (feeds abiertos)</h2>

  <h3>CDMX – Centro / Zona urbana</h3>
  <iframe 
    src="https://www.webcamtaxi.com/en/mexico/mexico-city.html"
    width="640" 
    height="360" 
    loading="lazy"
    style="border:none;">
  ...
  <h3>Guadalajara – Glorieta La Minerva</h3>
  <iframe 
    src="https://www.earthtv.com/en/webcam/guadalajara-minerva-roundabout"
    width="640" 
    height="360" 
    loading="lazy"
    style="border:none;">
  ...
  <h3>Cabo San Lucas – Vista urbana</h3>
  <iframe 
    src="https://www.skylinewebcams.com/en/webcam/mexico/baja-california-sur/cabo-san-lucas.html"
    width="640" 
    height="360" 
    loading="lazy"
    style="border:none;">
